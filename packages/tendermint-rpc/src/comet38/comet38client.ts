import { JsonRpcRequest, JsonRpcSuccessResponse } from "@filosof-copilot-cosmjs/json-rpc";
...
export class Comet38Client {
   ...
   */
  public static async connect(endpoint: string | HttpEndpoint | HttpProxyEndpoint): Promise<Comet38Client> {
